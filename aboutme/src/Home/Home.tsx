        ...
        <div className={"block-5 bk-gray"}>
          <div className={"box-container"}>
            <div className={"text-box"}>
              <div className={"container bk-red white text-align-center"}>
                <p>
                  Volutamente non ho scelto un corso di laurea in architettura perché la mia passione e il mio obiettivo
                  è
                  da sempre quello di arredare abitazioni private. Perciò, avendo già, piena consapevolezza di quello
                  che
          ...
          <div className={"text-container"}>
            <p className={"text-align-center"}>
              ...
              che potesse fornirmi tutte le competenze necessarie per iniziare fin da subito a lavorare con i clienti.
            </p>
          </div>
          <div className={"text-container-2"}>
            <p className={"text-align-center bk-darkGray white"}>
              Decisi di mettere da parte tutti i miei risparmi per andare a studiare interior design a Milano.
              Chiaramente non era sufficiente e dunque scelsi di aprire un finanziamento per pagarmi gli studi.
            </p>
          </div>
        </div>
        <div className={"block-6 bk-gray"}>
          <div className={"box-container"}>
            <div className={"postCard bk-white"}>
              ...
              <p className={"text-align-center"}>
                Oggi sono contenta di aver avviato il mio business di successo e di avere Carlo, che mi aiuta in questo
                progetto, gestendomi tutta la parte legata al sito web e appoggiandomi in ogni mia scelta.
              </p>
            </div>
          </div>
          <div className={"box-container-2"}>
            <div className={"img"}/>
            <p className={"text-align-center"}>
              Nonostante la distanza di questi anni, entrambi crediamo nelle potenzialità di questo progetto e non
